...
func (a *ArchiveApiService) UIDVaultsVaultNameArchivesPost(ctx context.Context, uID string, vaultName string, xCasContentSha256 string, contentLength string, xCasSha256TreeHash string, localVarOptionals *UIDVaultsVaultNameArchivesPostOpts) (*http.Response, error) {
	var (
...
func (a *ArchiveApiService) UIDVaultsVaultNameMultipartUploadsUploadIDPut(ctx context.Context, uID string, vaultName string, uploadID string, contentRange string, xCasContentSha256 string, xCasSha256TreeHash string, localVarOptionals *UIDVaultsVaultNameMultipartUploadsUploadIDPutOpts) (*http.Response, error) {
	var (
